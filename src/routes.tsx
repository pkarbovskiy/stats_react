        ...
        <Provider store={store}>
            <Router>
                ...
                <HamburgerMenu isMenuShown={isMenuShown} toggleMenu={toggleMenu}>
                    ...
                    <hr />
                    <Link to="https://twitter.com/streamsn1pers/" className="link">
                        <svg viewBox="0 0 512 512">
                    ...
                    <Link to="https://www.reddit.com/r/streamsn1pers" className="link">
                        <svg viewBox="0 0 512 512">
                ...
                <main>
                    ...
                    <Route exact path="/video/:videoId/" component={VideoPage} >
                        <Route exact path="clip/:clipId" component={VideoPage} />
                    </Route>
