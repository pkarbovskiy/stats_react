...
const LolSearchPage = ({ location }:
    ...
    return (
        <div className="">
            ...
            {loaded && search.players.length === 0 && searchString[1] != null && <p className="p-6">Sorry! We couldn't find '{searchString[1]}' in any recent Twitch Broadcasts. Check back soon!</p>}
